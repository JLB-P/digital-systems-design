...
HD_PWD='C:/repo/systemverilog/L07_edge detector/L07_edge detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_detect_moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_detect_moore.tcl
