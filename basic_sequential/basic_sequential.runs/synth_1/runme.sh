...
HD_PWD='C:/repo/systemverilog/basic_sequential/basic_sequential.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log free_bin_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source free_bin_count.tcl
